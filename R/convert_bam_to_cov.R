...
#' @param map_profile The mappability profile from a host genome (we only have
...
#'     information
convert_bam_to_cov <- function(bam_file, covs, map_profile = mappability_profile, paired = F) {
  if (missing(covs)) {
